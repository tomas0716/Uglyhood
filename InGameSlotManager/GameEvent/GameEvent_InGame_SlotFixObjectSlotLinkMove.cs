...
public class GameEvent_InGame_SlotFixObjectSlotLinkMove : GameEvent
{
    ...
    public GameEvent_InGame_SlotFixObjectSlotLinkMove(SlotManager pSlotManager, SlotFixObject pSlotFixObject, Slot pFrom, Slot pTo, float fMoveTime)
    {
        ...
        eventValue = new TransformerEvent_Vector3(fMoveTime * 0.5f, pFrom.GetPosition() + new Vector2(0, GameDefine.ms_fLinkSlotWarpInterval));
        m_pPos.AddEvent(eventValue);
        eventValue = new TransformerEvent_Vector3(fMoveTime * 0.5f, pTo.GetPosition() + new Vector2(0, -GameDefine.ms_fLinkSlotWarpInterval));
        m_pPos.AddEvent(eventValue);
        eventValue = new TransformerEvent_Vector3(fMoveTime, pTo.GetPosition());
        m_pPos.AddEvent(eventValue);

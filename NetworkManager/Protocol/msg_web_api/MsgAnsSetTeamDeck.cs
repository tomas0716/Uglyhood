...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsSetTeamDeck : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsSetTeamDeck");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsSetTeamDeck(");
      sb.Append("Error: ");

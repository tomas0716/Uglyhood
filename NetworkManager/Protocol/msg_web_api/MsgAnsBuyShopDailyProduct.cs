...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsBuyShopDailyProduct : TBase
  {
    ...
    public MsgAnsBuyShopDailyProduct() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsBuyShopDailyProduct");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsBuyShopDailyProduct(");
      sb.Append("Error: ");

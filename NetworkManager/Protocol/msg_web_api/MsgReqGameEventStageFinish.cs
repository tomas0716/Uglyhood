...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqGameEventStageFinish : TBase
  {
    private long _uid;
    ...
    public MsgReqGameEventStageFinish() {
      this._i_ModeId = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqGameEventStageFinish");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqGameEventStageFinish(");
      sb.Append("Uid: ");
      sb.Append(Uid);
      sb.Append(",I_ModeId: ");
      sb.Append(I_ModeId);

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsPurchaseShopProduct : TBase
  {
    ...
    public MsgAnsPurchaseShopProduct() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsPurchaseShopProduct");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsPurchaseShopProduct(");
      sb.Append("Error: ");

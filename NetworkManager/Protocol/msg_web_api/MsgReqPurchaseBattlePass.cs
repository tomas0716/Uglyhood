...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqPurchaseBattlePass : TBase
  {
    private long _uid;
    ...
    public MsgReqPurchaseBattlePass() {
      this._i_BuySeq = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqPurchaseBattlePass");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqPurchaseBattlePass(");
      sb.Append("Uid: ");
      sb.Append(Uid);
      sb.Append(",I_BuySeq: ");
      sb.Append(I_BuySeq);

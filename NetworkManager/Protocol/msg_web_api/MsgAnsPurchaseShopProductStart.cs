...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsPurchaseShopProductStart : TBase
  {
    ...
    public MsgAnsPurchaseShopProductStart() {
      this._i_BuySeq = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsPurchaseShopProductStart");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsPurchaseShopProductStart(");
      sb.Append("Error: ");

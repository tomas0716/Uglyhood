...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsSetUserDelete : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsSetUserDelete");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsSetUserDelete(");
      sb.Append("Error: ");

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsGetLastPackagePurchaseBuySeq : TBase
  {
    ...
    public MsgAnsGetLastPackagePurchaseBuySeq() {
      this._i_BuySeq = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsGetLastPackagePurchaseBuySeq");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsGetLastPackagePurchaseBuySeq(");
      sb.Append("Error: ");

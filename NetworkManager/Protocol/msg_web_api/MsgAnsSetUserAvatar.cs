...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsSetUserAvatar : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsSetUserAvatar");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsSetUserAvatar(");
      sb.Append("Error: ");

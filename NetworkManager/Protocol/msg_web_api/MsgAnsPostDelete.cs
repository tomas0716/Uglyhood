...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsPostDelete : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsPostDelete");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsPostDelete(");
      sb.Append("Error: ");

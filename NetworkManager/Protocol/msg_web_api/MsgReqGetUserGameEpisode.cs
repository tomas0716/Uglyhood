...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqGetUserGameEpisode : TBase
  {
    private long _uid;
    ...
    public MsgReqGetUserGameEpisode() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqGetUserGameEpisode");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqGetUserGameEpisode(");
      sb.Append("Uid: ");
      sb.Append(Uid);

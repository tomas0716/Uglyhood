...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsUserGetOfflineReward : TBase
  {
    ...
    public MsgAnsUserGetOfflineReward() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsUserGetOfflineReward");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsUserGetOfflineReward(");
      sb.Append("Error: ");

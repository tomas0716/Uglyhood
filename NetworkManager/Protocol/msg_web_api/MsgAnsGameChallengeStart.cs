...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsGameChallengeStart : TBase
  {
    ...
    public MsgAnsGameChallengeStart() {
      this._i_Ap = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsGameChallengeStart");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsGameChallengeStart(");
      sb.Append("Error: ");

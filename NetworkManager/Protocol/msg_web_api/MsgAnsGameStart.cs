...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsGameStart : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsGameStart");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsGameStart(");
      sb.Append("Error: ");

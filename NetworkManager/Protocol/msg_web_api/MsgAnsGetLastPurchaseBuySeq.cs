...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsGetLastPurchaseBuySeq : TBase
  {
    ...
    public MsgAnsGetLastPurchaseBuySeq() {
      this._i_BuySeq = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsGetLastPurchaseBuySeq");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsGetLastPurchaseBuySeq(");
      sb.Append("Error: ");

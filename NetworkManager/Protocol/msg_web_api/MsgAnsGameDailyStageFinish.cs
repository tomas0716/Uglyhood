...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsGameDailyStageFinish : TBase
  {
    ...
    public MsgAnsGameDailyStageFinish() {
            ...
            if (field.Type == TType.Map) {
              {
                ...
                {
                  int _key82;
                  sg.protocol.common.GameReward _val83;
                  _key82 = iprot.ReadI32();
                  _val83 = new sg.protocol.common.GameReward();
                  _val83.Read(iprot);
                  M_GameReward[_key82] = _val83;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsGameDailyStageFinish");
      ...
      if (M_GameReward != null && __isset.m_GameReward) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (int _iter84 in M_GameReward.Keys)
          {
            oprot.WriteI32(_iter84);
            M_GameReward[_iter84].Write(oprot);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsGameDailyStageFinish(");
      sb.Append("Error: ");

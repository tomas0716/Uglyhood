...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsSetRuneDeck : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsSetRuneDeck");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsSetRuneDeck(");
      sb.Append("Error: ");

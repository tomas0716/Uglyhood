...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqUseApChargeItem : TBase
  {
    private long _uid;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqUseApChargeItem");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqUseApChargeItem(");
      sb.Append("Uid: ");
      sb.Append(Uid);
      sb.Append(",I_ItemId: ");
      sb.Append(I_ItemId);

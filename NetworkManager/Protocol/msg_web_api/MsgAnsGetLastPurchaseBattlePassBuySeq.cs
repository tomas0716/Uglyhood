...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsGetLastPurchaseBattlePassBuySeq : TBase
  {
    ...
    public MsgAnsGetLastPurchaseBattlePassBuySeq() {
      this._i_BuySeq = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsGetLastPurchaseBattlePassBuySeq");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsGetLastPurchaseBattlePassBuySeq(");
      sb.Append("Error: ");

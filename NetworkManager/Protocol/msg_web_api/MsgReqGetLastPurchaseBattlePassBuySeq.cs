...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqGetLastPurchaseBattlePassBuySeq : TBase
  {
    private long _uid;
    ...
    public MsgReqGetLastPurchaseBattlePassBuySeq() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqGetLastPurchaseBattlePassBuySeq");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqGetLastPurchaseBattlePassBuySeq(");
      sb.Append("Uid: ");
      sb.Append(Uid);

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqGetLastPackagePurchaseBuySeq : TBase
  {
    private long _uid;
    ...
    public MsgReqGetLastPackagePurchaseBuySeq() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqGetLastPackagePurchaseBuySeq");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqGetLastPackagePurchaseBuySeq(");
      sb.Append("Uid: ");
      sb.Append(Uid);

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsGameEventPvpFinish : TBase
  {
    ...
    public MsgAnsGameEventPvpFinish() {
    }
            ...
            if (field.Type == TType.Map) {
              {
                ...
                {
                  int _key147;
                  sg.protocol.common.GameReward _val148;
                  _key147 = iprot.ReadI32();
                  _val148 = new sg.protocol.common.GameReward();
                  _val148.Read(iprot);
                  M_GameReward[_key147] = _val148;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsGameEventPvpFinish");
      ...
      if (M_GameReward != null && __isset.m_GameReward) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (int _iter149 in M_GameReward.Keys)
          {
            oprot.WriteI32(_iter149);
            M_GameReward[_iter149].Write(oprot);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsGameEventPvpFinish(");
      sb.Append("Error: ");

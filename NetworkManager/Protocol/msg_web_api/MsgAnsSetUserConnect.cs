...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsSetUserConnect : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsSetUserConnect");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsSetUserConnect(");
      sb.Append("Error: ");

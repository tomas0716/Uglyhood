...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsSetBoosterDeck : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsSetBoosterDeck");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsSetBoosterDeck(");
      sb.Append("Error: ");

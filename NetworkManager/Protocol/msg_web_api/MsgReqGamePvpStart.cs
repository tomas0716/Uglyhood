...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqGamePvpStart : TBase
  {
    private long _uid;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqGamePvpStart");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqGamePvpStart(");
      sb.Append("Uid: ");
      sb.Append(Uid);
      sb.Append(",I_DeckId: ");
      sb.Append(I_DeckId);

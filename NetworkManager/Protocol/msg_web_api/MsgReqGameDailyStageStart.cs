...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqGameDailyStageStart : TBase
  {
    private long _uid;
    ...
    public MsgReqGameDailyStageStart() {
      this._i_ModeId = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqGameDailyStageStart");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqGameDailyStageStart(");
      sb.Append("Uid: ");
      sb.Append(Uid);
      sb.Append(",I_ModeId: ");
      sb.Append(I_ModeId);

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsGameDailyStageStart : TBase
  {
    ...
    public MsgAnsGameDailyStageStart() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsGameDailyStageStart");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsGameDailyStageStart(");
      sb.Append("Error: ");

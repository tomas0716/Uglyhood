...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqGetUserGameChapter : TBase
  {
    private long _uid;
    ...
    public MsgReqGetUserGameChapter() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqGetUserGameChapter");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqGetUserGameChapter(");
      sb.Append("Uid: ");
      sb.Append(Uid);

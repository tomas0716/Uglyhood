...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqPurchasePackageShopProduct : TBase
  {
    private long _uid;
    ...
    public MsgReqPurchasePackageShopProduct() {
      this._i_BuySeq = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqPurchasePackageShopProduct");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqPurchasePackageShopProduct(");
      sb.Append("Uid: ");
      sb.Append(Uid);
      sb.Append(",I_BuySeq: ");
      sb.Append(I_BuySeq);

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsPurchaseBattlePass : TBase
  {
    ...
    public MsgAnsPurchaseBattlePass() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsPurchaseBattlePass");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsPurchaseBattlePass(");
      sb.Append("Error: ");

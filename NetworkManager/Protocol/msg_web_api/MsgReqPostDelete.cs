...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqPostDelete : TBase
  {
    private long _uid;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqPostDelete");
      ...
      if (L_PostSeq != null && __isset.l_PostSeq) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (int _iter106 in L_PostSeq)
          {
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqPostDelete(");
      sb.Append("Uid: ");
      sb.Append(Uid);
      sb.Append(",L_PostSeq: ");
      sb.Append(L_PostSeq);

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsGameEventStageStart : TBase
  {
    ...
    public MsgAnsGameEventStageStart() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsGameEventStageStart");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsGameEventStageStart(");
      sb.Append("Error: ");

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsRenewShopDailyProduct : TBase
  {
    ...
    public MsgAnsRenewShopDailyProduct() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsRenewShopDailyProduct");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsRenewShopDailyProduct(");
      sb.Append("Error: ");

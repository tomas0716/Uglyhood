...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsInGameUseItem : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsInGameUseItem");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsInGameUseItem(");
      sb.Append("Error: ");

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsPostConfirm : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsPostConfirm");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsPostConfirm(");
      sb.Append("Error: ");

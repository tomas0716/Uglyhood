...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsBuyShopBasicProduct : TBase
  {
    ...
    public MsgAnsBuyShopBasicProduct() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsBuyShopBasicProduct");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsBuyShopBasicProduct(");
      sb.Append("Error: ");

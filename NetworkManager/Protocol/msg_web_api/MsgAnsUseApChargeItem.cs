...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsUseApChargeItem : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsUseApChargeItem");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsUseApChargeItem(");
      sb.Append("Error: ");

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqPostReward : TBase
  {
    private long _uid;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqPostReward");
      ...
      if (L_PostSeq != null && __isset.l_PostSeq) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (int _iter110 in L_PostSeq)
          {
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqPostReward(");
      sb.Append("Uid: ");
      sb.Append(Uid);
      sb.Append(",L_PostSeq: ");
      sb.Append(L_PostSeq);

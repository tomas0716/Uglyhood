...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsSetModeTeamDeck : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsSetModeTeamDeck");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsSetModeTeamDeck(");
      sb.Append("Error: ");

...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgReqSetUserConnect : TBase
  {
    private long _uid;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgReqSetUserConnect");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgReqSetUserConnect(");
      sb.Append("Uid: ");
      sb.Append(Uid);
      sb.Append(",Device_id: ");
      sb.Append(Device_id);

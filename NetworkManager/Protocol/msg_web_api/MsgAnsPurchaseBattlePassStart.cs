...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsPurchaseBattlePassStart : TBase
  {
    ...
    public MsgAnsPurchaseBattlePassStart() {
      this._i_BuySeq = 0;
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsPurchaseBattlePassStart");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsPurchaseBattlePassStart(");
      sb.Append("Error: ");

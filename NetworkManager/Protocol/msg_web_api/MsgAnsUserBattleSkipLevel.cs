...
namespace sg.protocol.msg_web_api
{
  ...
  [Serializable]
  #endif
  public partial class MsgAnsUserBattleSkipLevel : TBase
  {
    ...
    public MsgAnsUserBattleSkipLevel() {
    }
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MsgAnsUserBattleSkipLevel");
    ...
    public override string ToString() {
      StringBuilder sb = new StringBuilder("MsgAnsUserBattleSkipLevel(");
      sb.Append("Error: ");

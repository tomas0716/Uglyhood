...
public class GameEvent_PlayerCharacterAttackMissile : GameEvent
{
    ...
    public GameEvent_PlayerCharacterAttackMissile(Slot pSrcSlot, Slot pTargetSlot, ExcelData_ActionInfo pActionInfo, float fDamageRate, bool IsSelectTarget, DamageTargetInfo pDamageTargetInfo = null)
    {
        m_pSrcSlot = pSrcSlot;
	...
	public void OnDone_Timer_Attack_Delay(TransformerEvent eventValue)
	{
		...
		if (pPlayerCharacter != null)
		{
			...
			MainGame_Espresso_ProcessHelper.OnSkillActionDamage(m_pSrcSlot, m_pTargetSlot, m_pActionInfo, m_pActionInfo.m_eDamageType, m_pActionInfo.m_eDamageBaseUnitRole, m_pActionInfo.m_eDamageBaseUnitProperty,
																pActionLevelUpInfo.m_nChange_DamageBaseRate, m_fDamageRate, m_pDamageTargetInfo.m_pConditionInfo.m_fRelativeDamageRate);

...
public class NetComponent_GetCharacterPackageProduct_ForScenario : TNetComponent_SuccessOrFail<EventArg_Null, EventArg_Null, Error>
{
    ...
    public override void OnEvent(EventArg_Null Arg)
    {
        ...
        pReq.I_PackageKind = (int)ePackageType.Growth;

...
public class NetComponent_GetShopPackageProduct_ForScenario : TNetComponent_SuccessOrFail<EventArg_Null, EventArg_Null, Error>
{
    public NetComponent_GetShopPackageProduct_ForScenario()
    {
    ...
    {
        NetLog.Log("NetComponent_GetShopPackageProduct_ForScenario : OnEvent");

        MsgReqGetShopPackageProduct pReq = new MsgReqGetShopPackageProduct();
        pReq.Uid = MyInfo.Instance.m_nUserIndex;
        pReq.I_PackageKind = (int)ePackageType.Chapter;
